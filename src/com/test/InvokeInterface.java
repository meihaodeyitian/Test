...
public class InvokeInterface {
	...
	static String testurl = "https://172.17.15.151:20080/mailbusi/cs/mail/";
	
	
	static String pnoneNum="13994000000";
	public static void main(String[] args) throws Exception {
		System.out.println("输入验证的地址：1.151;2.237.20080;3.10243;4.250;");
		Scanner n = new Scanner(System.in);
		int num1 = n.nextInt();
		if (1 == num1) {
			testurl = "https://172.17.15.151:20080/mailbusi/cs/mail/";
		} else if (2 == num1) {
			testurl = "https:// 221.176.66.237:20080/mailbusi/cs/mail/";
//			testurl = "https://172.17.15.152:20080/mailbusi/cs/mail/";
		} else if (3 == num1) {
			// http模式访问
			testurl = "http://172.17.15.151:10243/mailbusi/cs/mail/";
			System.out.println("testurl:"+testurl);
			System.out.println("http输入验证的号码：");
			...
			//测试250,用HTTPS方式
			testurl = "https://172.17.15.250:20080/mailbusi/cs/mail/";
//			Http250 http=new Http250();
//			http.test250(testurl);
//			return;
		}
